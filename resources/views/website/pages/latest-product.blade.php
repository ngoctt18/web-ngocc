	...
	<div class="container">
		<div class="row">
			<div id="center_column" class="center_column col-sm-12 col-md-12">
				...
				<h1 class="page-heading product-listing cat-name">Sản phẩm mới nhất</h1>
						...
						<div class="product-container text-left product-block">
							<div class="product-image-container image">
								<a class="product_img_link" href="{{ route('web.product_detail',['id'=>$product->id,'name'=>$product->slug]) }}" title="{{$product->name}}">
									<img class="replace-2x img-responsive" src="{{$product->ImageProduct??asset("images/products/product4.jpg")}}" alt="{{$product->name}}">
									<span class="product-additional" data-idproduct="1119718980">
										<img class="replace-2x img-responsive" alt="{{$product->name}}" src="{{$product->ImageProductDetails[0]??asset("images/products/product3.jpg")}}">
									</span>
								</a>
