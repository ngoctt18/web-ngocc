			...
			<tbody>
				...
				<tr role="row" class="align-middle">
					...
					<td>
						...
						<a href="{{ route('admin.news.edit', ['id' => $item->id], false) }}" class="btn btn-success btn-xs marB5" title="Sửa tin tức"><i class="fa fa-edit"></i></a>
						<a href="{{ route('admin.news.destroy', ['id' => $item->id], false) }}" class="btn btn-delete btn-danger btn-xs marB5" style=" padding: 1px 6px; " title="Xóa tin tức"><i class="fa fa-trash-o"></i></a>
					</td>
				</tr>
				@endforeach
			</tbody>
