...
<p>
	<a href="{{ route('writer.news.create') }}" class="btn btn-primary">Thêm bài viết</a> &emsp; <span class="pull-right marT15">Tổng số: {{ $news->total() }}</span>
</p>
<div class="box">
		...
		<table id="example1" class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr role="row" class="align-middle">
					...
					<td>{{ str_limit(html_entity_decode($item->content), 100, '...') }}</td>
					...
					<td>
						...
						<a href="{{ route('writer.news.edit', ['id' => $item->id], false) }}" class="btn btn-success btn-xs marB5" title="Sửa tin tức"><i class="fa fa-edit"></i></a>
						<a href="{{ route('writer.news.destroy', ['id' => $item->id], false) }}" class="btn btn-delete btn-danger btn-xs marB5" style=" padding: 1px 6px; " title="Xóa tin tức"><i class="fa fa-trash-o"></i></a>
					</td>
				</tr>
				@endforeach
			</tbody>
		...
		<div class="modal-content">
			<form method="POST">
				<div class="modal-body">
					...
					<h4>Bạn có muốn xóa bài viết này?</h4>
				</div>
