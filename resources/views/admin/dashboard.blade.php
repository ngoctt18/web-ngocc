...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var PieData = [
        { value : {{$orders->where('status', '4')->count()}}, color : '#ff4242', highlight: '#ff4242', label : 'Đơn hàng bị hủy' },
        { value : {{$orders->where('status', '2')->count()}}, color : '#00a65a', highlight: '#00a65a', label : 'Đơn hàng giao thành công' },
        { value : {{$orders->where('status', '0')->count()}}, color : '#00c0ef', highlight: '#00c0ef', label : 'Đơn hàng chờ xử lý' },
        { value : {{$orders->where('status', '1')->count()}}, color : '#3c8dbc', highlight: '#3c8dbc', label : 'Đơn hàng đang giao' },
        { value : {{$orders->where('status', '3')->count()}}, color : '#333', highlight: '#333', label : 'Đơn hàng giao thất bại' }
        ];
        var pieOptions = {
