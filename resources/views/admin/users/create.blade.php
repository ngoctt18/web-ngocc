	...
	<form role="form" method="POST" action="{{ route('admin.users.store', [], false) }}" enctype="multipart/form-data">
		<div class="box-body">
			...
			<div class="form-group">
				...
				<input type="password" class="form-control" id="password" placeholder="Mật khẩu" name="password" value="{{old('password')}}">
			...
			<div class="form-group">
				...
				<select class="form-control" style="width: 20%;" name="status" id="status">
					...
					<option value="0" {{old('status') == '2' ? 'selected' : ''}}>Dừng hoạt động</option>
				</select>
